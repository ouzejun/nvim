vim.cmd [[
  ...
  highlight BufferLineWarningSelected           guifg=#E5C890 guibg=none gui=bold
  highlight BufferLineErrorSelected             guifg=#E78284 guibg=none gui=bold
  highlight BufferLineHintSelected              guifg=#A5ADCE guibg=none gui=bold
  highlight BufferLineErrorDiagnosticSelected   guifg=#E78284 guibg=none gui=bold
  highlight BufferLineNumbersSelected           guifg=#A5ADCE guibg=none gui=bold
  highlight BufferLineBufferSelected            guifg=#A5ADCE guibg=none gui=bold
  highlight BufferLineBufferVisible             guifg=#A5ADCE guibg=none gui=bold
  highlight BufferLinePickSelected              guifg=#E78284 guibg=none gui=bold
  highlight BufferLinePick                      guifg=#A5ADCE guibg=none gui=bold
